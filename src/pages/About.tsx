      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-muted-foreground text-lg leading-relaxed">
            ...
            bravery in Ile-Ife inspired me to look at the tech industry and ask:
            Where are the women? According to UNESCO, women are still vastly
            under-represented in STEM. In a field where 91.7% of developers are
            male, Moremi Techstars Foundation is here to disrupt the status quo.
          </p>

          <p className="text-muted-foreground text-lg leading-relaxed mt-4">
            We are a non-profit powered by passion and a team of incredible
            volunteers. We exist to educate, equip, and empower African girls to
            step into the light of technology. Whether it's inspiring a young
            girl to pick up her first laptop or supporting a woman navigating a
            tech career, we are here to ensure the future of tech is female.
          </p>

          <p className="text-muted-foreground text-lg leading-relaxed mt-4">
            Let's build this legacy together. For our daughters, for Nigeria, and
            for the bright future of Africa. 🇳🇬
          </p>
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        <AnimateOnScroll animation="animate-fade-in-up">
          ...
          <div className="flex gap-4 mb-10">
            ...
            <p className="text-muted-foreground text-lg leading-relaxed">
              To create an avenue where women are equally represented and thrive
              across all career roles in Technology.
            </p>
          </div>
        </AnimateOnScroll>
        ...
        <AnimateOnScroll animation="animate-fade-in-up" delay={150}>
          ...
          <div className="flex gap-4">
            ...
            <div className="text-muted-foreground text-lg leading-relaxed space-y-2">
              ...
              <p>
                • Inspiring the women of tomorrow, today in technology.
              </p>
              <p>
                • To help women consider, advance and stay in tech
              </p>
              <p>
                • Giving a woman a voice for voice to achieve sustainability and
...
export default About;                  <h3 className="font-semibold font-heading text-foreground text-sm">{member.name}</h3>
